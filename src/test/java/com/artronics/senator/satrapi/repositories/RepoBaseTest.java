...
import com.artronics.senator.satrapi.TestContextConfiguration;
...
import com.artronics.senator.satrapi.helper.CreateEntities;
...
public class RepoBaseTest
{
    ...
    {
        SdwnNetwork network = CreateEntities.createNet(ip);

        List<SdwnController> controllers = new ArrayList<>();
        for (int i = 0; i < num; i++) {
            SdwnController e = CreateEntities.createCtrl();
